...
namespace AutoVersion{
	...
	static const long  _BUILD = 317;
	static const long  _REVISION = 1694;
	
	//Miscellaneous Version Types
	static const long  _BUILDS_COUNT = 3240;
	#define  _RC_FILEVERSION 0,3,317,1694
	#define  _RC_FILEVERSION_STRING "0, 3, 317, 1694\0"
	static const char  _FULLVERSION_STRING[] = "0.3.317.1694";
