...
INCLUDES = -I$(_BASE.LIB) -I$(_BASE.INCLUDE) 
LDFLAGS = -L$(_BASE.LIB)  -s
RCFLAGS = 
LDLIBS = $(T_LDLIBS) -l$(_GLU.LFLAGS) -l$(_GLUT.LFLAGS) -l$(_OPENGL.LFLAGS)  -lstdc++
...
Debug_target.BIN = ../bin/Debug/libsoil.a
Debug_target.OBJ = SOIL.o image_DXT.o image_helper.o stb_image_aug.o 
DEP_FILES += SOIL.d image_DXT.d image_helper.d stb_image_aug.d 
...
Release_target.BIN = ../bin/Release/libsoil.a
Release_target.OBJ = SOIL.o image_DXT.o image_helper.o stb_image_aug.o 
DEP_FILES += SOIL.d image_DXT.d image_helper.d stb_image_aug.d 
...
Unitary_Debug_target.BIN = ../bin/UnitaryDebug/libsoil.a
Unitary_Debug_target.OBJ = SOIL.o image_DXT.o image_helper.o stb_image_aug.o 
DEP_FILES += SOIL.d image_DXT.d image_helper.d stb_image_aug.d 
...
Unitary_Release_target.BIN = ../bin/UnitaryRelease/libsoil.a
Unitary_Release_target.OBJ = SOIL.o image_DXT.o image_helper.o stb_image_aug.o 
DEP_FILES += SOIL.d image_DXT.d image_helper.d stb_image_aug.d 
