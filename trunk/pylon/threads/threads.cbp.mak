...
Debug_target.BIN = ../bin/Debug/libthreads.so
Debug_target.OBJ = exthread.o mutex.o thread.o threads.o 
DEP_FILES += exthread.d mutex.d thread.d threads.d 
...
Release_target.BIN = ../bin/Release/libthreads.so
Release_target.OBJ = exthread.o mutex.o thread.o threads.o 
DEP_FILES += exthread.d mutex.d thread.d threads.d 
...
Release_target : LDFLAGS +=  $(CREATE_LIB) $(CREATE_DEF)
...
Unitary_Debug_target.BIN = ../bin/UnitaryDebug/libthreads.a
Unitary_Debug_target.OBJ = exthread.o mutex.o thread.o threads.o 
DEP_FILES += exthread.d mutex.d thread.d threads.d 
...
Unitary_Release_target.BIN = ../bin/UnitaryRelease/libthreads.a
Unitary_Release_target.OBJ = exthread.o mutex.o thread.o threads.o 
DEP_FILES += exthread.d mutex.d thread.d threads.d 
