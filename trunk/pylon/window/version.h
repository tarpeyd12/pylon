...
namespace AutoVersion{
	...
	static const long  _BUILD = 174;
	static const long  _REVISION = 910;
	
	//Miscellaneous Version Types
	static const long  _BUILDS_COUNT = 1024;
	#define  _RC_FILEVERSION 0,1,174,910
	#define  _RC_FILEVERSION_STRING "0, 1, 174, 910\0"
	static const char  _FULLVERSION_STRING[] = "0.1.174.910";
