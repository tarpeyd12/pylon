...
namespace pogelInterface
{
    static MethodDef pogelMethods[] = {
        ...
        // pogel simulations
        { "sim_new",            (CFunction)addsimulation,           VarArgs, NULL },
        { "sim_toggle",         (CFunction)togglesimulation,        VarArgs, NULL },
        { "sim_weight",         (CFunction)togglesimweight,         VarArgs, NULL },
        { "sim_set_gravity_3f", (CFunction)setsimulationgravity_3f, VarArgs, NULL },
        { "sim_get_gravity_3f", (CFunction)getsimulationgravity_3f, VarArgs, NULL },
        { "sim_set_itter",      (CFunction)setsimulationcollitters, VarArgs, NULL },
        { "sim_get_itter",      (CFunction)getsimulationcollitters, VarArgs, NULL },
        { "sim_add_object_s",   (CFunction)addobject,               VarArgs, NULL },
        { "sim_clear",          (CFunction)clearsimulation,         VarArgs, NULL },
        // object controll
        ...
        { "getsimulationgravity_3f", (CFunction)getsimulationgravity_3f, VarArgs, NULL },
