...
RCFLAGS = 
LDLIBS = $(T_LDLIBS) -l$(_PYTHON.LFLAGS)  -lstdc++
...
Debug_target.BIN = ../bin/Debug/libscriptengine.so
Debug_target.OBJ = executor.o interpriterthread.o scriptengine.o stringparser.o subinterpriter.o 
DEP_FILES += executor.d interpriterthread.d scriptengine.d stringparser.d subinterpriter.d 
...
Debug_target : T_LDLIBS = -lthreads -lfileloader 
ifdef LMAKE
...
Release_target.BIN = ../bin/Release/libscriptengine.so
Release_target.OBJ = executor.o interpriterthread.o scriptengine.o stringparser.o subinterpriter.o 
DEP_FILES += executor.d interpriterthread.d scriptengine.d stringparser.d subinterpriter.d 
...
Release_target : T_LDLIBS = -lthreads -lfileloader 
ifdef LMAKE
...
Unitary_Debug_target.BIN = ../bin/UnitaryDebug/libscriptengine.a
Unitary_Debug_target.OBJ = executor.o interpriterthread.o scriptengine.o stringparser.o subinterpriter.o 
DEP_FILES += executor.d interpriterthread.d scriptengine.d stringparser.d subinterpriter.d 
...
Unitary_Debug_target : T_LDLIBS = -lthreads -lfileloader 
ifdef LMAKE
...
Unitary_Release_target.BIN = ../bin/UnitaryRelease/libscriptengine.a
Unitary_Release_target.OBJ = executor.o interpriterthread.o scriptengine.o stringparser.o subinterpriter.o 
DEP_FILES += executor.d interpriterthread.d scriptengine.d stringparser.d subinterpriter.d 
...
Unitary_Release_target : T_LDLIBS = -lthreads -lfileloader 
ifdef LMAKE
