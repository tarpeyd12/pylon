...
bool
POGEL::PHYSICS::line_triangle_collision( const POGEL::POINT& start, const POGEL::POINT& end, const POGEL::TRIANGLE& triangle, POGEL::POINT* collision2d, POGEL::POINT* collision3d )
{
    ...
    *collision3d = start + vct * collision2d->z;
...
bool
POGEL::PHYSICS::ray_triangle_collision( const POGEL::POINT& start, const POGEL::VECTOR& direction, const POGEL::TRIANGLE& triangle, POGEL::POINT* collision2d, POGEL::POINT* collision3d )
{
    //triangle.getbounding();
    //if(!POGEL::LINE(start,end).bounding.checkbounding(start, triangle.middle(), triangle.bounding)) return false;

    float orig[] = { start.x, start.y, start.z };
    POGEL::VECTOR vct( direction.normal() );
    float dir[] = { vct.x, vct.y, vct.z };
...
bool
POGEL::PHYSICS::triangle_collision( const POGEL::TRIANGLE& tria, const POGEL::TRIANGLE& trib, POGEL::POINT* p1, POGEL::POINT* p2 )
{
    //tria.makebounding();
    //trib.makebounding();
    if( !trib.getbounding().checkbounding( tria.getbounding() ) )
    {
        return false;
    }
    ...
    bool collided;
    int cols = 0, colpos[2];
    for( unsigned int a = 0 ; a < 6 && cols < 2 ; ++a )
    {
        unsigned int a1 = (a+0)%3;
        unsigned int a2 = (a+1)%3;

        // check the rays of the first triangle, agenst the plane of the second triangle
        if( a < 3 )
        {
            collided = POGEL::PHYSICS::line_triangle_collision( tria.vertex[a1], tria.vertex[a2], trib, &p2d[a], &p3d[a] );
        }
        // check the rays of the second triangle, agenst the plane of the first triangle
        else
        {
            collided = POGEL::PHYSICS::line_triangle_collision( trib.vertex[a1], trib.vertex[a2], tria, &p2d[a], &p3d[a] );
        }
        if( collided && ++cols == 2 )
        {
            colpos[cols-1] = a;
...
bool
POGEL::PHYSICS::solid_line_collision(int type, POGEL::PHYSICS::SOLID* obj, const POGEL::POINT& start, const POGEL::POINT& end, POGEL::TRIANGLE* tri, POGEL::POINT* col2d, POGEL::POINT* col3d )
{
    if( !POGEL::LINE( start, end ).bounding.checkbounding( obj->getbounding() ) )
    {
        return false;
    }

    POGEL::MATRIX mat = POGEL::MATRIX(obj->position, obj->rotation);
    POGEL::MATRIX mat2 = mat;
    mat2.invert();

    POGEL::POINT start2 = mat2.transformPoint( start );
    POGEL::POINT end2 = mat2.transformPoint( end );
    ...
    if( type == PHYSICS_LINESOLID_COLLISION_GREATEST )
    {
        ...
        {
            POGEL::TRIANGLE tritmp = obj->gettriangle( i );
            if(POGEL::PHYSICS::line_triangle_collision(start2, end2, tritmp, col2d, col3d))
            {
                if(col2d->z > dist)
                {
                    *tri = mat.transformTriangle( tritmp );
                    dist = col2d->z;
                    index = i;
                }
                ret = true;
    ...
    if( type == PHYSICS_LINESOLID_COLLISION_LEAST )
    {
    ...
    if( type == PHYSICS_LINESOLID_COLLISION_FIRST )
    {
        for( unsigned long i = 0; i < numfaces; ++i )
        {
            POGEL::TRIANGLE tritmp = obj->gettriangle( i );
...
bool
POGEL::PHYSICS::solid_line_collision(POGEL::PHYSICS::SOLID* obj, const POGEL::POINT& start, const POGEL::POINT& end, POGEL::TRIANGLE* tri, POGEL::POINT* col2d, POGEL::POINT* col3d )
{
    if( !POGEL::LINE( start, end ).bounding.checkbounding( obj->getbounding() ) )
    {
        return false;
    ...
    POGEL::MATRIX mat( obj->position, obj->rotation );
    POGEL::MATRIX mat2( mat );
    mat2.invert();
...
bool
POGEL::PHYSICS::solid_ray_collision(int type, POGEL::PHYSICS::SOLID* obj, const POGEL::POINT& start, const POGEL::VECTOR& direction, POGEL::TRIANGLE* tri, POGEL::POINT* col2d, POGEL::POINT* col3d )
{
    POGEL::MATRIX mat( obj->position, obj->rotation );
    POGEL::MATRIX mat2(mat);
    mat2.invert();
    ...
    POGEL::POINT start2 = mat2.transformPoint( start );
    POGEL::VECTOR direction2 = mat2.transformVector( direction );
    ...
    if( type == PHYSICS_LINESOLID_COLLISION_GREATEST )
    {
        ...
        {
            POGEL::TRIANGLE tritmp = obj->gettriangle( i );
            if(POGEL::PHYSICS::ray_triangle_collision(start2, direction2, tritmp, col2d, col3d))
            {
                if(col2d->z > dist)
                {
                    *tri = mat.transformTriangle( tritmp );
...
bool
POGEL::PHYSICS::solid_collision(POGEL::PHYSICS::SOLID* obj1, POGEL::PHYSICS::SOLID* obj2, POGEL::POINT* contact, POGEL::VECTOR* normal1, POGEL::VECTOR* normal2, float *area )
{
    POGEL::POINT p1, p2;
...
// this is brute force
float
POGEL::PHYSICS::line_point_distance_BRUTE( const POGEL::POINT& point, const POGEL::LINE& line, POGEL::POINT* pol )
{
...
float
POGEL::PHYSICS::line_point_distance( const POGEL::POINT& refpoint, const POGEL::LINE& line, POGEL::POINT* pol )
{
    POGEL::POINT start = line.getStart();
    POGEL::POINT end = line.getEnd();
    POGEL::POINT closest;
...
float
POGEL::PHYSICS::point_triangle_distance_BRUTE( const POGEL::POINT& point, const POGEL::TRIANGLE& triangle, POGEL::POINT* pol )
{
    ...
    POGEL::LINE edges[3];
    POGEL::POINT verts[3];
    for(unsigned int i = 0; i< 3; i++) { edges[i] = triangle.getEdge(i); verts[i] = triangle.vertex[i]; }
...
float
POGEL::PHYSICS::point_triangle_distance( const POGEL::POINT& point, const POGEL::TRIANGLE& triangle, POGEL::POINT* pol )
{
    POGEL::POINT res2d, res3d;
    ...
    bool col = POGEL::PHYSICS::line_triangle_collision( point, pointtmp, triangle, &res2d, &res3d );
...
inline
float
POGEL::PHYSICS::getvprime( float m1, float m2, float v1, float v2 )
{
    return ( v1 * (m1-m2) + (2.0f*m2*v2) ) / (m1+m2);
}

void
POGEL::PHYSICS::calcElasticDirections( const POGEL::VECTOR& vn, POGEL::PHYSICS::SOLID* s1, POGEL::PHYSICS::SOLID* s2, POGEL::VECTOR* v )
{
...
inline
float
POGEL::PHYSICS::getvf( float m1, float m2, float v1, float v2, float cr )
{
    return ( (cr*m2) * (v2-v1) + (m1*v1) + (m2*v2) ) / (m1+m2);
}

void
POGEL::PHYSICS::calcInelasticDirections( const POGEL::VECTOR& vn, POGEL::PHYSICS::SOLID* s1, POGEL::PHYSICS::SOLID* s2, POGEL::VECTOR* v )
{
