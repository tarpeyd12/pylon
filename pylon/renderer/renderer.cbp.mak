...
INCLUDES = -I$(_BASE.INCLUDE) -I$(_BASE.LIB) -I$(_PYTHON.LIB) -I$(_PYTHON.INCLUDE) 
LDFLAGS = -L$(_BASE.LIB) -L$(_PYTHON.LIB)  -s
RCFLAGS = 
LDLIBS = $(T_LDLIBS) -l$(_OPENGL.LFLAGS) -l$(_GLUT.LFLAGS) -l$(_GLU.LFLAGS) -l$(_PYTHON.LFLAGS)  -lstdc++
...
Debug_target.BIN = ../bin/Debug/librenderer.so
Debug_target.OBJ = camera.o cmd.o display.o draw.o hud.o init.o key.o light.o mouse.o physics.o quad.o renderer.o selection.o subrenderer.o timer.o window.o 
DEP_FILES += camera.d cmd.d display.d draw.d hud.d init.d key.d light.d mouse.d physics.d quad.d renderer.d selection.d subrenderer.d timer.d window.d 
...
Debug_target : T_LDLIBS = -lpogel -lfileloader -lobjectloader 
ifdef LMAKE
...
Release_target.BIN = ../bin/Release/librenderer.so
Release_target.OBJ = camera.o cmd.o display.o draw.o hud.o init.o key.o light.o mouse.o physics.o quad.o renderer.o selection.o subrenderer.o timer.o window.o 
DEP_FILES += camera.d cmd.d display.d draw.d hud.d init.d key.d light.d mouse.d physics.d quad.d renderer.d selection.d subrenderer.d timer.d window.d 
...
Release_target : T_LDLIBS = -lpogel -lfileloader -lobjectloader 
ifdef LMAKE
...
Unitary_Debug_target.BIN = ../bin/UnitaryDebug/librenderer.a
Unitary_Debug_target.OBJ = camera.o cmd.o display.o draw.o hud.o init.o key.o light.o mouse.o physics.o quad.o renderer.o selection.o subrenderer.o timer.o window.o 
DEP_FILES += camera.d cmd.d display.d draw.d hud.d init.d key.d light.d mouse.d physics.d quad.d renderer.d selection.d subrenderer.d timer.d window.d 
...
Unitary_Debug_target : T_LDLIBS = -lpogel -lfileloader -lobjectloader 
ifdef LMAKE
...
Unitary_Release_target.BIN = ../bin/UnitaryRelease/librenderer.a
Unitary_Release_target.OBJ = camera.o cmd.o display.o draw.o hud.o init.o key.o light.o mouse.o physics.o quad.o renderer.o selection.o subrenderer.o timer.o window.o 
DEP_FILES += camera.d cmd.d display.d draw.d hud.d init.d key.d light.d mouse.d physics.d quad.d renderer.d selection.d subrenderer.d timer.d window.d 
...
Unitary_Release_target : T_LDLIBS = -lpogel -lfileloader -lobjectloader 
ifdef LMAKE
