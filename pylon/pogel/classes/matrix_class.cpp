...
POGEL::MATRIX::MATRIX(POGEL::POINT point, int i)
{
    ...
    switch(i) {
        case MATRIX_CONSTRUCT_ROTATION: // for constructing rotation
            ...
            *this = POGEL::MATRIX(point.x, MATRIX_CONSTRUCT_X_ROTATION) * MATRIX(point.y, MATRIX_CONSTRUCT_Y_ROTATION) * MATRIX(point.z, MATRIX_CONSTRUCT_Z_ROTATION);
        break;
...
POGEL::MATRIX::MATRIX(POGEL::POINT position, POGEL::POINT rotation)
{
    ...
    *this = (POGEL::MATRIX(rotation, MATRIX_CONSTRUCT_ROTATION) * POGEL::MATRIX(position, MATRIX_CONSTRUCT_TRANSLATION) );
    //print();
}

void
POGEL::MATRIX::set(float* m)
{
...
void
POGEL::MATRIX::multiplyby(float m)
{
...
void
POGEL::MATRIX::raistopower(int p)
{
...
POGEL::MATRIX::toquat() const
{
    ...
    // testing for gimble lock (I think)
    if(t>0.00001)
    {
...
POGEL::MATRIX&
POGEL::MATRIX::operator=(const POGEL::MATRIX& m)
{
