...
namespace AutoVersion{
	...
	static const long  _BUILD = 536;
	static const long  _REVISION = 2864;
	
	//Miscellaneous Version Types
	static const long  _BUILDS_COUNT = 6986;
	#define  _RC_FILEVERSION 0,5,536,2864
	#define  _RC_FILEVERSION_STRING "0, 5, 536, 2864\0"
	static const char  _FULLVERSION_STRING[] = "0.5.536.2864";
